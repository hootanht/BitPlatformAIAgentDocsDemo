...
using BitPlatformAIAgentDocsDemo.Shared;
using BitPlatformAIAgentDocsDemo.Shared.Attributes;
using BitPlatformAIAgentDocsDemo.Client.Core.Services;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        {
            options.InjectJavascript($"/_content/BitPlatformAIAgentDocsDemo.Server.Api/scripts/swagger-utils.js?v={Environment.TickCount64}");
        });
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("BitPlatformAIAgentDocsDemo.Client") is true).ToArray());
...
<sitemapindex xmlns=""http://www.sitemaps.org/schemas/sitemap/0.9"">
   <sitemap>
      <loc>{0}sitemap.xml</loc>
        ...
        {
            var urls = AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("BitPlatformAIAgentDocsDemo.Client") is true)
