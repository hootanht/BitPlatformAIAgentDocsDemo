...
namespace BitPlatformAIAgentDocsDemo.Tests;
...
public partial class AppTestServer : IAsyncDisposable
{
        ...
        Action<ConfigurationManager>? configureTestConfigurations = null)
    {
        ...
        builder.Configuration["ConnectionStrings:SqliteConnectionString"] = "Data Source=BitPlatformAIAgentDocsDemoDb;Mode=Memory;Cache=Shared;";
