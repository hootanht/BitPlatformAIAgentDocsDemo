...
namespace BitPlatformAIAgentDocsDemo.Client.Maui;
    ...
    protected override async void OnStart()
    {
        try
        {
                ...
                webViewVersion.Major < minimumSupportedWebViewVersion)
            {
                ...
                await App.Current!.Windows[0].Page!.DisplayAlert("BitPlatformAIAgentDocsDemo", localizer[nameof(AppStrings.UpdateWebViewThroughGooglePlay)], localizer[nameof(AppStrings.Ok)]);
