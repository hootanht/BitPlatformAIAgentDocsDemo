...
using BitPlatformAIAgentDocsDemo.Client.Maui.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "BitPlatformAIAgentDocsDemo.Client.Maui");
