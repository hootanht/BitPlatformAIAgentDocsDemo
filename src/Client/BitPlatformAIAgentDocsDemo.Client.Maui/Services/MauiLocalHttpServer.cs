...
namespace BitPlatformAIAgentDocsDemo.Client.Maui.Services;
        ...
        localHttpServer = new WebServer(o => o
            ...
            .WithModule(new ActionModule("/external-js-runner.html", HttpVerbs.Get, async ctx =>
            {
                try
                {
                    ...
                    await using var file = Assembly.Load("BitPlatformAIAgentDocsDemo.Client.Maui").GetManifestResourceStream("BitPlatformAIAgentDocsDemo.Client.Maui.wwwroot.external-js-runner.html")!;
            ...
            .WithModule(new ActionModule("/app.js", HttpVerbs.Get, async ctx =>
            {
                try
                {
                    ...
                    await using var file = Assembly.Load("BitPlatformAIAgentDocsDemo.Client.Maui").GetManifestResourceStream("BitPlatformAIAgentDocsDemo.Client.Maui.wwwroot.scripts.app.js")!;
                    await file.CopyToAsync(ctx.Response.OutputStream, ctx.CancellationToken);
                }
                catch (Exception exp)
                {
