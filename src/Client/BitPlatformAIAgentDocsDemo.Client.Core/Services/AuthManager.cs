...
using BitPlatformAIAgentDocsDemo.Client.Core.Services.HttpMessageHandlers;

namespace BitPlatformAIAgentDocsDemo.Client.Core.Services;
...
public partial class AuthManager : AuthenticationStateProvider, IAsyncDisposable
{
    ...
    public async Task<bool> TryEnterElevatedAccessMode(CancellationToken cancellationToken)
    {
        ...
        var token = await promptService.Show(localizer[AppStrings.EnterElevatedAccessToken], title: "BitPlatformAIAgentDocsDemo", otpInput: true);
