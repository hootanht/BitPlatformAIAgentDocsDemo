...
using BitPlatformAIAgentDocsDemo.Client.Windows.Services;
using Microsoft.Extensions.Logging;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;

namespace BitPlatformAIAgentDocsDemo.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "BitPlatformAIAgentDocsDemo.Client.Windows").Build();
        ...
        var form = new Form()
        {
            Text = "BitPlatformAIAgentDocsDemo",
            Height = 768,
            Width = 1024,
