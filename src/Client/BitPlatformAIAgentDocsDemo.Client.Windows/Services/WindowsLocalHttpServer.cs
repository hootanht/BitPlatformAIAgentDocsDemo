        ...
        localHttpServer = new WebServer(o => o
            ...
            .WithModule(new ActionModule("/app.js", HttpVerbs.Get, async ctx =>
            {
                try
                {
                    ...
                    var filePath = Path.Combine(AppContext.BaseDirectory, @"wwwroot\_content\BitPlatformAIAgentDocsDemo.Client.Core\scripts\app.js");
                    if (File.Exists(filePath) is false)
                    {
                        filePath = Path.Combine(AppContext.BaseDirectory, @"..\..\..\..", @"BitPlatformAIAgentDocsDemo.Client.Core\wwwroot\scripts\app.js");
                    }
